...
export function Hero() {
    return (
        <main className="bg-secondary-700 pt-[220px] relative overflow-hidden lg:pt-[150px]">
            ...
            <div className="absolute top-0 rounded-full left-0 w-[400px] h-[400px] bg-primary opacity-5 blur-[100px] lg:w-[200px] "></div>
            <div className="absolute bottom-0 rounded-full right-0 w-[500px] h-[400px] bg-primary opacity-5 blur-[100px] lg:w-[200px] "></div>
            <div className="absolute bottom-[-464px] rounded-full left-[-450px] w-[900px] h-[900px] opacity-5 border-primary border-[100px] lg:w-[200px]"></div>
            <div className="absolute top-[-471px] rounded-full right-[-450px] w-[900px] h-[900px] opacity-5 border-primary border-[100px] lg:w-[200px]"></div>
            <div className="max-w-screen-xl w-full mx-auto px-[28px]">
                <h1 className="font-bold text-[72px] text-center text-primary max-w-[800px] mx-auto leading-[150%] mb-[24px] lg:text-[64px] md:text-[24px] md:text-start">
